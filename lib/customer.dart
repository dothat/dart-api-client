...
library dothatapis.customer.v1;
...
const core.String USER_AGENT = 'dart-api-client customer/v1';
...
class CustomerApi {
  ...
  CustomerApi(http.Client client,
  ...
  async.Future<CustomerAddress> addCustomerAddressRequest(
      CustomerAddress request, core.String svcProviderId, core.String custId,
      {core.String $fields}) {
    var _url = null;
    ...
    return _response.then((data) => new CustomerAddress.fromJson(data));
  }
  ...
  async.Future<CustomerContact> addCustomerContactRequest(
      CustomerContact request, core.String svcProviderId, core.String custId,
      {core.String $fields}) {
    var _url = null;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia = null;
    ...
    var _response = _requester.request(_url, "POST",
        ...
        uploadMedia: _uploadMedia,
        downloadOptions: _downloadOptions);
    return _response.then((data) => new CustomerContact.fromJson(data));
  }
  ...
  async.Future<Customer> createCustomerRequest(
      Customer request, core.String svcProviderId,
      {core.String $fields}) {
    var _url = null;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia = null;
    ...
    _url = commons.Escaper.ecapeVariable('$svcProviderId') + '/customers';
  ...
  async.Future<CustomerCollection> findCustomersRequest(
    ...
    var _response = _requester.request(_url, "GET",
        ...
        uploadMedia: _uploadMedia,
        downloadOptions: _downloadOptions);
    return _response.then((data) => new CustomerCollection.fromJson(data));
  }
  ...
  async.Future<CustomerContact> removeCustomerContactRequest(
    ...
    if (custContactId == null) {
      throw new core.ArgumentError("Parameter custContactId is required.");
    }
    if (expunge == null) {
      throw new core.ArgumentError("Parameter expunge is required.");
    }
    ...
    _url = commons.Escaper.ecapeVariable('$svcProviderId') +
        ...
        commons.Escaper.ecapeVariable('$custId') +
        '/contacts/' +
        commons.Escaper.ecapeVariable('$custContactId');
  ...
  async.Future<Customer> updateCustomerRequest(
      Customer request, core.String svcProviderId, core.String custId,
      {core.String $fields}) {
    var _url = null;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia = null;
  ...
  CustomerCollection.fromJson(core.Map _json) {
    if (_json.containsKey("items")) {
      items = (_json["items"] as core.List)
          .map<Customer>((value) => new Customer.fromJson(value))
          .toList();
    }
  }

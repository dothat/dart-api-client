...
class OrderApi {
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<OrderCollection> findOrdersForCustomer(
    core.String svcProviderId,
    core.String custId,
    ...
    return OrderCollection.fromJson(
  ...
  async.Future<OrderCollection> findOrdersForServiceProvider(
    ...
    final _url = commons.escapeVariable('$svcProviderId') + '/orders';
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Order> updateOrder(
    Order request,
    core.String svcProviderId,
    core.String custId,
    core.String ordId, {
...
class Order {
  ...
  Order.fromJson(core.Map _json) {
    ...
    if (_json.containsKey('orderItems')) {
      orderItems = (_json['orderItems'] as core.List)
          .map<OrderItem>((value) =>
              OrderItem.fromJson(value as core.Map<core.String, core.dynamic>))
          .toList();
    }
    if (_json.containsKey('orderSource')) {
      orderSource = _json['orderSource'] as core.String;
    }
    if (_json.containsKey('placementStatus')) {
      placementStatus = _json['placementStatus'] as core.String;
    }
    if (_json.containsKey('version')) {
      version = _json['version'] as core.String;
    }
  ...
  core.Map<core.String, core.dynamic> toJson() => {
        ...
        if (orderItems != null)
          'orderItems': orderItems!.map((value) => value.toJson()).toList(),
        if (orderSource != null) 'orderSource': orderSource!,
        if (placementStatus != null) 'placementStatus': placementStatus!,
        if (version != null) 'version': version!,
      };
}

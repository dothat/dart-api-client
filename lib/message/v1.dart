...
const core.String USER_AGENT = 'dart-api-client message/v1';

/// API to access Messages
class MessageApi {
  ...
  MessageApi(http.Client client,
      {core.String rootUrl: "https://dev-dothat-api.appspot.com/_ah/api/",
      core.String servicePath: "message/v1/serviceProviders/"})
      : _requester =
  ...
  async.Future<Message> createCustomerMessage(
      Message request, core.String svcProviderId, core.String custId,
      {core.String $fields}) {
    var _url = null;
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Message> createMessage(
      Message request, core.String svcProviderId,
      {core.String $fields}) {
    var _url = null;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia = null;
    ...
    _url = commons.Escaper.ecapeVariable('$svcProviderId') + '/messages';
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Message> getCustomerMessage(
      core.String svcProviderId, core.String custId, core.String msgId,
      {core.String $fields}) {
    var _url = null;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia = null;
    ...
    if (msgId == null) {
      throw new core.ArgumentError("Parameter msgId is required.");
    }
    if ($fields != null) {
      _queryParams["fields"] = [$fields];
    }
    ...
    _url = commons.Escaper.ecapeVariable('$svcProviderId') +
        ...
        commons.Escaper.ecapeVariable('$custId') +
        '/messages/' +
        commons.Escaper.ecapeVariable('$msgId');
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Message> getMessage(core.String svcProviderId, core.String msgId,
      {core.String $fields}) {
    var _url = null;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia = null;
